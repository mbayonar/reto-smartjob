...
public class RespuestaControladorServicio {
    ...
    public RespuestaControlador obtenerRespuestaDeErrorCrearConMensaje(String nombreEntidad, String mensajeError) {
    	String error = MessageFormat.format(mensajeCrearError, nombreEntidad) + mensajeError;
        return RespuestaControlador.obtenerRespuestaDeError(error);
    }
